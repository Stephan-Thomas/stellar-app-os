  ...
  return (
    <section className={cn("space-y-3", className)} aria-labelledby={descriptionId}>
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        {showSatelliteToggle ? (
          <div className="inline-flex rounded-md border border-border bg-background p-1" role="group" aria-label="Map view mode">
            <button
              type="button"
              className={cn(
      ...
      <p className="text-xs text-muted-foreground">
        Accessible location reference: {projectName} is located in {locationLabel}. The pin marks the project site on the interactive map.
      </p>
