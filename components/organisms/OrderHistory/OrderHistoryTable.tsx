...
export function OrderHistoryTable() {
    ...
    const exportToCSV = () => {
        ...
        const headers = ["Date", "Type", "Project", "Quantity", "Price", "Status", "TX Hash", "Network"];
        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div className="flex items-center gap-3">
                    <Text variant="small" className="font-medium whitespace-nowrap">Filter by type:</Text>
                    <Select
                        value={filter}
                        ...
                        {loading ? (
                            ...
                            orders.map((order) => (
                                <TableRow key={order.id}>
                                    ...
                                    <TableCell>
                                        <Badge variant={order.type === "buy" ? "default" : "secondary"} className="capitalize">
                                            {order.type}
                                        </Badge>
                                    </TableCell>
