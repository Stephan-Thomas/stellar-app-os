...
function VerifyEmailContent() {
    ...
    return (
        <div className="w-full max-w-md w-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-500">
            <div className="p-8 text-center space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed max-w-sm mx-auto">
                        {status === "idle" ? "We've sent a verification link to your email address. Please click the link to verify your account." :
                            status === "verifying" ? "Please wait while we confirm your email address." :
                                status === "success" ? "Your email has been successfully verified. Redirecting you to the dashboard..." :
                                    status === "expired" ? "The verification link has expired. Don't worry, you can request a new one." :
                                        errorMessage}
                    </p>
                </div>
            ...
            <div className={`bg-zinc-50 dark:bg-zinc-800/50 p-4 border-t border-zinc-100 dark:border-zinc-800 transition-all duration-500 text-center ${status === "idle" ? "opacity-100 h-auto" : "opacity-0 h-0 overflow-hidden py-0"}`}>
